      ...
      <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 sm:gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {people.reduce(
                (total, person) => total + (person.external_identities?.length || 0),
                0
              )}
            </div>
          </CardContent>
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent className="sm:max-w-md">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-sm font-medium">Slack Username (Optional)</label>
                    <Input
                      value={newPerson.slack_username || ""}
                      onChange={(e) =>
                        setNewPerson({
                          ...newPerson,
                  ...
                  <div>
                    ...
                    <Input
                      value={newPerson.github_username || ""}
                      onChange={(e) =>
                        setNewPerson({
                          ...newPerson,
            ...
            <TableBody>
              {filteredPeople.map((person) => (
                <TableRow key={person.id}>
                  ...
                  <TableCell>
                    <Badge variant={getRoleColor(person.role)}>
                      {person.role}
                    </Badge>
                  </TableCell>
                  <TableCell>
                    <div className="flex space-x-1">
                      {person.external_identities?.map((identity) => (
                        <Badge
                          key={identity.id}
                          variant="outline"
                        ...
                        >
                          ...
                          <span className="text-xs">
                            {identity.username || identity.external_id}
                          </span>
                        </Badge>
                      ))}
                    </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setSelectedPerson({ ...selectedPerson, role: value })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
